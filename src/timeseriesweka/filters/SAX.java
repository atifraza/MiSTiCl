...
public class SAX extends SimpleBatchFilter {
    ...
    public double[] generateBreakpoints(int alphabetSize) 
    	...
    	switch(alphabetSize) {
            ...
            case 3: {  breakpoints = new double[]{   -0.4307,    0.4307, maxVal }; break; }
            case 4: {  breakpoints = new double[]{   -0.6745,         0,    0.6745, maxVal }; break; }
            case 5: {  breakpoints = new double[]{   -0.8416,   -0.2533,    0.2533,    0.8416, maxVal }; break; }
            case 6: {  breakpoints = new double[]{   -0.9674,   -0.4307,         0,    0.4307,    0.9674, maxVal }; break; }
            case 7: {  breakpoints = new double[]{   -1.0676,   -0.5659,   -0.1800,    0.1800,    0.5659,    1.0676, maxVal }; break; }
            case 8: {  breakpoints = new double[]{   -1.1503,   -0.6745,   -0.3186,         0,    0.3186,    0.6745,    1.1503, maxVal}; break; }
            case 9: {  breakpoints = new double[]{   -1.2206,   -0.7647,   -0.4307,   -0.1397,    0.1397,    0.4307,    0.7647,    1.2206, maxVal}; break; }
            case 10: { breakpoints = new double[]{   -1.2816,   -0.8416,   -0.5244,   -0.2533,         0,    0.2533,    0.5244,    0.8416,    1.2816, maxVal}; break; }
